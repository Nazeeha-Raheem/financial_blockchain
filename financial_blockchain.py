...
# Suppress the Streamlit warning about deprecated st.cache
...
st.markdown("<h1 style='text-align: center;'>Cybersecurity Framework for Enhancing Financial Transaction Security through Blockchain Implementation </h1>", unsafe_allow_html=True)
st.markdown("<h2 style='text-align: center;'>Decentralized Trust: Leveraging Blockchain for Resilient Financial Cybersecurity</h2>", unsafe_allow_html=True)
